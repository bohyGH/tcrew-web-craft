...
const IndexEn = () => {
  ...
  const whyTcrew = ["More than 25 years of experience", "Specialization in banking and telecommunications", "Individual approach to each client", "Innovative solutions using AI"];
